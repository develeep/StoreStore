...
viewsRouter.use('/newproducts', serveStatic('newproducts'));
...
viewsRouter.use('/admin/productUpdate', serveStatic('productUpdate'));
viewsRouter.use('/admin/productList', serveStatic('productsList'));
